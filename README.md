...
Check out the [contributing](https://github.com/luizhap/proffy/blob/master/CONTRIBUTING.md) page to see the best places to file issues, start discussions and begin contributing.
...
This project is under the [MIT license](https://github.com/luizhap/proffy/master/LICENSE).
